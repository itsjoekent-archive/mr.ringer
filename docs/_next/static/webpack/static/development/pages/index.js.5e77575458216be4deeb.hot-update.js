  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    function runScript() {
      ...
      function getPoint(x, y) {
        if (gridDimension === '2d') {
          var gridPixelsPerWideUnit = canvasWidth / 2 / gridLength;
          var canvasX = x * gridPixelsPerWideUnit + canvasWidth / 2;
          var gridPixelsPerTallUnit = canvasHeight / 2 / gridLength;
      ...
      function arrow(fromX, fromY, toX, toY) {
        ...
        var headLength = canvasWidth * 0.03;
        ctx.beginPath();
        ...
        context.lineTo(tox - headlen * Math.cos(angle + Math.PI / 6), toy - headlen * Math.sin(angle + Math.PI / 6)); // const from = getPoint(fromX, fromY);
        // const to = getPoint(toX, toY);
        //
        // const leftArrowDirection = to.x >= 0 ? 1 : -1;
        // const rightArrowDirection = to.y >= 0 ? 1 : -1;
        //
        // ctx.beginPath();
        // ctx.moveTo(from.x, from.y);
        // ctx.lineTo(to.x, to.y);
        // ctx.lineTo(to.x - ((canvasWidth * 0.03) * leftArrowDirection), to.y);
        // ctx.moveTo(to.x, to.y);
        // ctx.lineTo(to.x, to.y + ((canvasWidth * 0.03) * rightArrowDirection));
        // ctx.stroke();
        // ctx.closePath();
      }
...
//# sourceMappingURL=index.js.5e77575458216be4deeb.hot-update.js.map