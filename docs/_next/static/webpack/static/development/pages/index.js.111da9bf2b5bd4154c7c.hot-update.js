  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    function runScript() {
      ...
      function grid(dimension, length) {
        ...
        if (dimension === '2d') {
          lineStyle(theme.colors.light, 4, 'square');
          ...
          ctx.beginPath();
          lineStyle(theme.colors.light, 0.1, 'square');
      ...
      function arrow(fromX, fromY, toX, toY) {
        ...
        var headLength = wideUnit * (gridLength * 0.005);
        ctx.beginPath();
...
//# sourceMappingURL=index.js.111da9bf2b5bd4154c7c.hot-update.js.map