        ...
        if (dimension === '2d') {
          ...
          for (var _xRow = -gridLength; _xRow < gridLength; _xRow += frequency) {
            for (var _yRow = -gridLength; _yRow < gridLength; _yRow += frequency) {
              ...
              var xOffset = "".concat(_xRow).length * 12 / 2;
              var yOffset = 12 / 2;
              ctx.font = '12px serif';
              ctx.fillStyle = theme.colors.light;
              ctx.fillText(_xRow, xLabel.x - xOffset, xLabel.y);
              ctx.fillText(_yRow, yLabel.x, yLabel.y - yOffset);
            }
          }
...
//# sourceMappingURL=index.js.c5237de49706663f8098.hot-update.js.map