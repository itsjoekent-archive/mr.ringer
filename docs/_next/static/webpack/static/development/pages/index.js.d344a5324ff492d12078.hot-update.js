...
/* harmony import */ var mr_ringer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! mr.ringer */ "./node_modules/mr.ringer/dist/mr.ringer.js");
/* harmony import */ var mr_ringer__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(mr_ringer__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _lessons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lessons */ "./src/lessons.js");
...
var LessonsColumn = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
...
var LessonsColumnHeader = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].h2.withConfig({
...
var LessonsColumnSubheader = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].p.withConfig({
...
var lessonTitleHoverFrames = function lessonTitleHoverFrames(theme) {
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["keyframes"])(["0%{background-position:0% 50%;}100%{background-position:100% 50%;}"]);
};

var LessonTitle = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].button.withConfig({
  ...
  return isActive && Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["color:", ";"], function (_ref27) {
...
var ChartColumn = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
...
var errorMessageEntrance = Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["keyframes"])(["0%{bottom:-100%;opacity:0;}100%{bottom:16px;opacity:1;}"]);
var ErrorMessage = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].p.withConfig({
...
var ChartCanvas = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].canvas.withConfig({
  displayName: "Sandbox__ChartCanvas",
  componentId: "sc-1yhnmvq-7"
})([""]);
var CodeColumn = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
...
function Sandbox(props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(_lessons__WEBPACK_IMPORTED_MODULE_4__["default"][0]),
      activeLesson = _useState[0],
      setActiveLesson = _useState[1];

  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(_lessons__WEBPACK_IMPORTED_MODULE_4__["default"][0].script),
      script = _useState2[0],
  ...
  var lessonsColumnRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    function runScript() {
      ...
      var Vector2 = mr_ringer__WEBPACK_IMPORTED_MODULE_3__["Vector2"];
      var topPadding = canvasHeight * 0.1;
      var leftPadding = canvasWidth * 0.1;
      var gridDimension = '2d';
      var gridLength = 100;

      function getPoint(x, y) {
        if (gridDimension === '2d') {
          var canvasGridWidth = canvasWidth - leftPadding;
          var canvasCenterX = canvasGridWidth / 2;
          var gridPixelsPerWideUnit = canvasGridWidth / gridLength;
          var canvasGridHeight = canvasHeight - topPadding;
          var canvasCenterY = canvasGridHeight / 2;
          var gridPixelsPerTallUnit = canvasGridHeight / gridLength;
          return {
            x: leftPadding + canvasCenterX + x * gridPixelsPerWideUnit,
            y: topPadding - canvasCenterY - y * gridPixelsPerTallUnit
          };
        }
      }
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    function resizeCanvas() {
      canvasRef.current.width = lessonsColumnRef.current.getBoundingClientRect().width;
      canvasRef.current.height = lessonsColumnRef.current.getBoundingClientRect().height;
    }
  ...
  }, "Click a lesson to learn more about the topic."), _lessons__WEBPACK_IMPORTED_MODULE_4__["default"].map(function (item, index) {
    return __jsx("span", {
      key: item.id,
      __self: _this,
      __source: {
  ...
  }, __jsx(react_codemirror2__WEBPACK_IMPORTED_MODULE_2__["Controlled"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["withTheme"])(Sandbox));

/***/ })

})
//# sourceMappingURL=index.js.d344a5324ff492d12078.hot-update.js.map