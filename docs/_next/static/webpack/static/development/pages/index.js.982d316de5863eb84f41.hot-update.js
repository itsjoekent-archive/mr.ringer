  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    function runScript() {
      ...
      function arrow(fromX, fromY, toX, toY) {
        ...
        var leftDash = Vector2.add(Vector2(to.x, to.y).normalize().scale(-1), Vector2(to.x, to.y));
        ctx.beginPath();
        ctx.moveTo(from.x, from.y);
        ctx.lineTo(to.x, to.y);
        ctx.lineTo(getPoint(leftDash.x, 0).x, to.y);
        ctx.stroke();
        ctx.closePath();
      }
...
//# sourceMappingURL=index.js.982d316de5863eb84f41.hot-update.js.map