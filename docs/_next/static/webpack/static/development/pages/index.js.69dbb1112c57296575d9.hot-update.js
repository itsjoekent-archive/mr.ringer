...
function buildSectionFromLine(line) {
  return {
    id: section.line.replace('# ', '').toLowerCase(),
    title: section.line.replace('# ', '')
  };
}
...
var sections = lines.filter(function (_ref) {
  ...
  return _objectSpread({}, lineData, {}, buildSectionFromLine(lineData));
});
sections.forEach(function (section, index) {
  var start = index;
  var end = (sections[index + 1] || {}).index || lines.length;
  var subSections = lines.slice(start, end).filter(function (_ref2) {
    var line = _ref2.line;
    return line.startsWitth('## ');
  });
});
...
//# sourceMappingURL=index.js.69dbb1112c57296575d9.hot-update.js.map