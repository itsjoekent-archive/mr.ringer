...
})(["display:flex;flex-direction:row;flex-wrap:wrap;width:100%;max-height:90vh;margin-top:48px;margin-bottom:48px;padding-top:16px;background-color:", ";border-top:2px solid ", ";border-bottom:2px solid ", ";position:relative;@media (min-width:1280px){height:90vh;max-height:600px;}&:before{content:'Mr. Ringer TI-84';", " font-size:", ";font-weight:700;font-style:italic;letter-spacing:", ";line-height:", ";text-transform:uppercase;color:", ";background-color:", ";border:2px solid ", ";border-radius:4px;position:absolute;left:50%;transform:translate(-50%);top:-0.65em;padding-left:16px;padding-right:16px;}"], function (_ref) {
...
})(["width:50%;padding:16px;position:relative;max-height:100%;@media (min-width:1280px){width:40%;}"]);
...
function Sandbox(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    function runScript() {
      ...
      try {
        ctx.clearRect(0, 0, canvasWidth, canvasHeight); // console.log()
...
//# sourceMappingURL=index.js.88deb654c0831cd78b73.hot-update.js.map