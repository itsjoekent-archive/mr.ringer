    ...
    function runScript() {
      ...
      function grid(dimension, length) {
        ...
        if (dimension === '2d') {
          ...
          for (var xRow = -gridLength + 1; xRow < gridLength; xRow += frequency) {
            for (var yRow = -gridLength + 1; yRow < gridLength; yRow += frequency) {
...
//# sourceMappingURL=index.js.b16eb7a4d4c59e5001e8.hot-update.js.map