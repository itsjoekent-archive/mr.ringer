        ...
        if (dimension === '2d') {
          ...
          for (var _xRow = -gridLength; _xRow < gridLength; _xRow += labelFrequency) {
            for (var _yRow = -gridLength; _yRow < gridLength; _yRow += labelFrequency) {
              ...
              ctx.fillText(_xRow, xLabel.x - xRowTextMetrics.width / 2, xLabel.y + xRowTextMetrics.actualBoundingBoxAscent + 2);
...
//# sourceMappingURL=index.js.b044fd3c947783c7e8fc.hot-update.js.map