        ...
        if (dimension === '2d') {
          ...
          for (var _xRow = -gridLength; _xRow < gridLength; _xRow += labelFrequency) {
            for (var _yRow = -gridLength; _yRow < gridLength; _yRow += labelFrequency) {
              ...
              var xRowTextMetrics = ctx.measureText(_xRow); // ctx.fillText(xRow, xLabel.x - (xRowTextMetrics.width / 2), xLabel.y + xRowTextMetrics.actualBoundingBoxAscent + 4);
              // ctx.fillText(yRow, yLabel.x + 4, yLabel.y + (xRowTextMetrics.actualBoundingBoxAscent / 2));
            }
          }
...
//# sourceMappingURL=index.js.bd6da4c56d4610c01313.hot-update.js.map