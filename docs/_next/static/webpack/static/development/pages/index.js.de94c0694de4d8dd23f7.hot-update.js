  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    function runScript() {
      ...
      function arrow(fromX, fromY, toX, toY) {
        ...
        ctx.lineTo(to.x - canvasWidth * 0.03 * direction, to.y);
        ctx.moveTo(to.x, to.y);
        ctx.lineTo(to.x, to.y + canvasWidth * 0.03 * direction);
        ctx.stroke();
        ctx.closePath();
      }
...
//# sourceMappingURL=index.js.de94c0694de4d8dd23f7.hot-update.js.map