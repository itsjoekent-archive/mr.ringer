    ...
    function runScript() {
      ...
      function grid(dimension, length) {
        ...
        if (dimension === '2d') {
          ...
          ctx.closePath();
          var labelFrequency = Math.round(gridLength / 2);

          for (var _xRow = -gridLength; _xRow < gridLength; _xRow += frequency) {
            for (var _yRow = -gridLength; _yRow < gridLength; _yRow += frequency) {
...
//# sourceMappingURL=index.js.a4a0cb097a896968aac9.hot-update.js.map