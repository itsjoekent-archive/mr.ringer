    ...
    function runScript() {
      ...
      function grid(dimension, length) {
        ...
        if (dimension === '2d') {
          ...
          ctx.closePath(); // const labelFrequency = Math.round(gridLength / 5);
          //
          // for (let xRow = -gridLength; xRow < gridLength; xRow += labelFrequency) {
          //   for (let yRow = -gridLength; yRow < gridLength; yRow += labelFrequency) {
          //     if (xRow === -gridLength
          //       || yRow === -gridLength
          //       || xRow === gridLength
          //       || yRow === gridLength
          ...
          //
          //     ctx.fillText(xRow, xLabel.x - (xRowTextMetrics.width / 2), xLabel.y + xRowTextMetrics.actualBoundingBoxAscent + 4);
...
//# sourceMappingURL=index.js.3d2a464888a6766647d1.hot-update.js.map